...
(* OASIS_START *)
(* DO NOT EDIT (digest: 558faf49d3466c988714d760ae63f4b7) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-inline"; "20"])]
                   },
                   {
                      lib_modules = ["Titanic"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "titanic"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "genero.ml"});
               Executable
                 ({
                     cs_name = "arvgenero";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "arvgenero.ml"});
               Executable
                 ({
                     cs_name = "id3gencls";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "id3gencls.ml"});
               Executable
                 ({
                     cs_name = "id3prgencls";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "id3prgencls.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "l\030R\156Äqø\022\028\002ê:;\137¯\152";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
